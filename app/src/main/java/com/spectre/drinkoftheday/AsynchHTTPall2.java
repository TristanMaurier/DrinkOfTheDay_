...
public class AsynchHTTPall2 extends AsyncTask<String, Integer, String> {
    private AppCompatActivity myActivity;

    public AsynchHTTPall2(AppCompatActivity AllDrinks) {
    ...
    protected void onPostExecute(String s) {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                try {
                    ...
                    while (Ingredient!="null") {
                        listeIngredrientsMeasure = listeIngredrientsMeasure + ";  " + Ingredient ;
                        if (Measure!="null"){
                            listeIngredrientsMeasure = listeIngredrientsMeasure + ": " + Measure;
                        }
                        x = x + 1;
                        xx = String.valueOf(x);
        ...
        text.setText(res); // Updates the textview
        ProgressBar pb = (ProgressBar) myActivity.findViewById(R.id.progressBar);
        pb.setProgress(5);
    }
