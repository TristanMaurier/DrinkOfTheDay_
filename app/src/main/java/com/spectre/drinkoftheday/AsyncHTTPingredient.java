...
public class AsyncHTTPingredient extends AsyncTask<String, Integer, String> {

    private AppCompatActivity myActivity;

    public AsyncHTTPingredient(AppCompatActivity DrinksByIngredient) { myActivity = DrinksByIngredient;
    }
